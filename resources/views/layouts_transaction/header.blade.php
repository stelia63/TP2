<div class="header">
    ...
    <div class="header-left">
        <a href="index.html" class="logo">
            <img src="assets3/img/logo.png" alt="Logo">
        </a>
        <a href="index.html" class="logo logo-small">
            <img src="assets3/img/logo-small.png" alt="Logo" width="30" height="30">
        </a>
    ...
    <ul class="nav user-menu">
                                ...
                                <div class="media d-flex">
                                    <span class="avatar avatar-sm flex-shrink-0">
                                        <img class="avatar-img rounded-circle" alt="Img"
                                            src="assets3/img/profiles/avatar-02.jpg">
                                    </span>
                        ...
                        <li class="notification-message">
                            <a href="javascript:void(0);">
                                <div class="media d-flex">
                                    <span class="avatar avatar-sm flex-shrink-0">
                                        <img class="avatar-img rounded-circle" alt="Img"
                                            src="assets3/img/profiles/avatar-03.jpg">
                                    </span>
                                    <div class="media-body flex-grow-1">
                        ...
                        <li class="notification-message">
                            <a href="javascript:void(0);">
                                <div class="media d-flex">
                                    <span class="avatar avatar-sm flex-shrink-0">
                                        <img class="avatar-img rounded-circle" alt="Img"
                                            src="assets3/img/profiles/avatar-04.jpg">
                                    </span>
                                    <div class="media-body flex-grow-1">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img src="assets3/img/profiles/avatar-07.jpg" alt="Img">
